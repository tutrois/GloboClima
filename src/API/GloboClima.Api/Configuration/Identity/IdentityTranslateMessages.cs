...
namespace GloboClima.API.Configuration.Identity
{
    /// <summary>
    /// Customiza as mensagens de erro do Identity.
    /// </summary>
    public class IdentityTranslateMessages : IdentityErrorDescriber
    {
