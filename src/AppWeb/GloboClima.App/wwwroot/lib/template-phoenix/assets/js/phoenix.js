      ...
      forms.forEach(form => {
        form.addEventListener(events.SUBMIT, e => {
          ...
          if (form.classList.contains('needs-validation')) {
            ...
            if (typeof CustomValidationWizzard === 'function') {
                // Se a função "CustomValidationWizzard" existir, o código que colocar aqui dentro será executado.
                // Caso contrario, não será executado.
                CustomValidationWizzard();
            }
            if (!form.checkValidity()) {
